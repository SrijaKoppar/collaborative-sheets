...
export default function Page() {
  ...
  const [docs, setDocs] = useState<SpreadsheetSummary[]>([])
  ...
  useEffect(() => {
    ...
    // Realtime document list, most recently updated first
    const docsQuery = query(collection(db, "documents"), orderBy("updatedAt", "desc"))
